...
object TangaIcons {
    ...
    val IndicatorGraphic = R.drawable.ic_indicator_graphic
    val Business = R.drawable.ic_business
    ...
    val Backward = R.drawable.ic_ten_back
    val Forward = R.drawable.ic_ten_forward
